...
export default function NotNullParameter<Msg>(message: Static<unknown, null, true, false, Msg>): ValidatorAbstract<unknown, null, true, false, Readonly<Instance<null, string>>>;
